...
// */
//public abstract class DawgLynxI2cDeviceSynch extends LynxI2cDeviceSynchV2 implements I2cDeviceSynchSimple, I2cDeviceSynchReadHistory
//{
//    //----------------------------------------------------------------------------------------------
//    // State
//    //----------------------------------------------------------------------------------------------
...
//
//    protected DawgLynxUsbUtil.Placeholder<TimestampedData> readTimeStampedPlaceholder = new DawgLynxUsbUtil.Placeholder<TimestampedData>(TAG, "readTimestamped");
//    private DawgLynxUsbUtil.Placeholder<TimestampedData> readStatusQueryPlaceholder = new DawgLynxUsbUtil.Placeholder<TimestampedData>(TAG, "readStatusQuery");
//
//    //----------------------------------------------------------------------------------------------
//    // Construction
//    //----------------------------------------------------------------------------------------------
//
//    protected DawgLynxI2cDeviceSynch(final Context context, final LynxModule module, int bus)
//    {
...
//        setBusSpeed(LynxI2cDeviceSynchV2.BusSpeed.STANDARD_100K);
...
//            handleException(e);
//        }
//        return DawgLynxUsbUtil.makePlaceholderValue((byte)0);
//    }
//
//    /*
...
//            {
//                DawgTimer.updateAllTimers();
//                if (requestTimer.milliseconds() > 80)
//                    keepTrying = false;
...
//    }
//
//    DawgTimer requestTimer = new DawgTimer();
//
//    @Override
